...
const BannerForm = ({ onClose, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('alt', formData.title);
      ...
      const response = await fetch(API_ENDPOINTS.BANNERSADD, {
        method: 'POST',
        headers: {
          ...getAuthHeader()
        },
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || 'Failed to add banner item');
      }
      ...
      setError(error.message || 'Failed to add banner item');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] flex flex-col">
        ...
        <div className="flex justify-between items-center p-4 border-b">
          <h2 className="text-lg font-semibold">Add Banner Item</h2>
          <button 
            onClick={onClose} 
